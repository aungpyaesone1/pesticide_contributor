                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" action="{{ route('post-register') }}" method="post">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" name="cityId" class="form-control form-control-user"
                                            id="exampleInputPassword" placeholder="City">
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="text" name="townshipId" class="form-control form-control-user"
                                            id="exampleRepeatPassword" placeholder="Township">
                                    </div>
                                </div>
